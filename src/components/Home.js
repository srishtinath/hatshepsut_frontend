...
class Home extends Component {
      ...
      return (
        <>
          <div className="home-content">
            ...
            <button onClick={this.seeIntroduction}>
              Re-read the introduction
            </button>
            <button onClick={this.continueStory}>
              Continue where you left off
            </button>
            <button onClick={this.guessCulpritfunction}>
              Guess the culprit
            </button>
            <button onClick={this.logoutUser}>Logout</button>
            <p></p>
            <p>
              Make sure you're playing on your desktop, with your screen full
              size.
            </p>
            <Hatshepsut />
          </div>
  ...
  render() {
    return (
      <div>
        <Switch>
          <Route path="/hatshepsut_frontend/home/setting" component={Setting} />
          <Route
            path="/hatshepsut_frontend/home/room"
            render={this.renderRooms}
          />
          <Route path="/hatshepsut_frontend/home/rooms" component={Rooms} />
          <Route path="/hatshepsut_frontend/guess" component={GuessCulprit} />
        ...
        {this.state.showItems ? (
          <div className="location-items">
            <Items />
            <button onClick={this.closeImages} id="close-items-btn">
              {"\u00D7"}
            </button>
          </div>
        ) : null}
